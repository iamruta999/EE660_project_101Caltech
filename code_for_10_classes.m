% This code performs classification on 10 classes
clear all;
clc;
...
numberOfTrainingImages = min([length(theFiles_1),length(theFiles_2),length(theFiles_3),length(theFiles_4),length(theFiles_5),...
    length(theFiles_6),length(theFiles_7),length(theFiles_8),length(theFiles_9),length(theFiles_10)])-20;
